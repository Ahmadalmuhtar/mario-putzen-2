    ...
    <footer className="bg-blue-300 gap-12 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left pt-6">
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 justify-items-center">
          ...
          <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
            <a href="https://www.marioputzen.com" target="_blank" className="flex items-center">
              <img src={img} className="h-24 pr-4" alt="Mario Putzen Logo" />
              <span>Mario Putzen</span>
            </a>
          </h6>
            <p>
            Mit einem Team erfahrener Reinigungskräfte und modernster Ausrüstung kümmern wir uns um Ihre Außen- und Innenflächen. Egal ob Büro-, Unterhalts- oder Glasreinigung
            </p>
          </div>
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              <a href="https://maps.app.goo.gl/hNbUnfKky8hWM4Av7" target="_blank">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              <a href="https://maps.app.goo.gl/Bvqzggn5wpECM8c87" target="_blank">
      ...
      <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700 h-6">
        ...
        <a
          ...
          href="https://marioputzen.com/" target="_blank"
        >
          Mario Putzen
        </a>
      </div>
